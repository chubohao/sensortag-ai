...
var _default = echarts.extendComponentView({
  ...
  renderInner: function (itemAlign, legendModel, ecModel, api) {
    ...
    each(legendModel.getData(), function (itemModel, dataIndex) {
      ...
      if (itemModel.ecModel.option.series[0].showVal) {
        value = itemModel.ecModel.option.series[0].data[dataIndex].value;
      } // Use empty string or \n as a newline string
      ...
      if (seriesModel) {
        ...
        var itemGroup = this._createItem(name, dataIndex, itemModel, legendModel, legendSymbolType, symbolType, itemAlign, color, selectMode, value);
        ...
        ecModel.eachRawSeries(function (seriesModel) {
          ...
          if (seriesModel.legendDataProvider) {
            ...
            var itemGroup = this._createItem(name, dataIndex, itemModel, legendModel, legendSymbolType, null, itemAlign, color, selectMode, value); // FIXME: consider different series has items with the same name.
  ...
  _createItem: function (name, dataIndex, itemModel, legendModel, legendSymbolType, symbolType, itemAlign, color, selectMode, value) {
    var itemWidth = legendModel.get('itemWidth');
    var itemHeight = legendModel.get('itemHeight');
    var inactiveColor = legendModel.get('inactiveColor');
    var symbolKeepAspect = legendModel.get('symbolKeepAspect');
    var rotate = legendModel.get('rotation');
    ...
    symbolKeepAspect == null ? true : symbolKeepAspect, rotate)); // Compose symbols
    // PENDING
    ...
    itemGroup.add(new graphic.Text({
      // rotation: rotate,
      rotation: (rotate || 0) * Math.PI / 180 || 0,
    ...
    itemGroup.add(new graphic.Text({
      ...
      style: graphic.setTextStyle({}, textStyleModel, {
        ...
        x: textX,
        y: itemHeight / 2,
        z: 2 // textFill: isSelected ? textStyleModel.getTextColor() : inactiveColor
    ...
    itemGroup.eachChild(function (child) {
      child.rotation = (rotate || 0) * Math.PI / 180 || 0;
      child.silent = true;

      if (child.shape) {
        child.shape.height = 15;
      }
    });
